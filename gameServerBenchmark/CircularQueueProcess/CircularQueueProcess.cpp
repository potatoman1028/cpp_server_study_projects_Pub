// CircularQueueProcess.cpp : Defines the entry point for the console application.
//
...
#include "../Network/NetIocp3.h"
#include "../Network/SimpleServer3.h"
...
class CTestServer : public CSimpleServer3<CTestNet>
{
public:
	VOID Begin(VOID)
	{
